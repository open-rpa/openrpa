...
namespace OpenRPA.Interfaces
{
    ...
    public interface IWebSocketClient
    {
        ...
        Task<object> QueueMessage(string exchange, string routingkey, object data, string replyto, string correlationId, int expiration, bool striptoken);
        Task<object> QueueMessage(string queuename, object data, string replyto, string correlationId, int expiration, bool striptoken);
        ...
        Task<T[]> InsertOrUpdateMany<T>(string collectionname, int w, bool j, string uniqeness, bool SkipResult, T[] items);
