...
namespace OpenRPA.NM.Activities
{
    public class NMEqualityComparer : IEqualityComparer<NMElement>
    {
        public bool Equals(NMElement element1, NMElement element2)
        {
            ...
            //{
            //    if (element1.xpath != element2.xpath) { Log.SelectorVerbose("xpath mismatch"); return false; }
            //}
            //if (!string.IsNullOrEmpty(element1.id) && !string.IsNullOrEmpty(element2.id))
            //{
            //    if (element1.id != element2.id) { Log.SelectorVerbose("id mismatch"); return false; }
            //}
            //if (!string.IsNullOrEmpty(element1.cssselector) && !string.IsNullOrEmpty(element2.cssselector))
            //{
            //    if (element1.cssselector != element2.cssselector) { Log.SelectorVerbose("cssselector mismatch"); return false; }
            //}
            //if (!string.IsNullOrEmpty(element1.classname) && !string.IsNullOrEmpty(element2.classname))
            //{
            //    if (element1.classname != element2.classname) { Log.SelectorVerbose("classname mismatch"); return false; }
            //}
            //if (element1.zn_id > 0 && element2.zn_id > 0)
            //{
            //    if (element1.zn_id != element2.zn_id) { Log.SelectorVerbose("zn_id mismatch"); return false; }
            //}
            //if (!string.IsNullOrEmpty(element1.Text) && !string.IsNullOrEmpty(element2.Text))
            //{
            //    if (element1.Text != element2.Text) { Log.SelectorVerbose("Text mismatch"); return false; }
            //}
            //return true;
