...
namespace OpenRPA.NM
{
    class PluginConfig
    {
        ...
        public static string[] unique_xpath_ids { get { return globallocal.GetProperty(pluginname, new string[] { "ng-model", "ng-reflect-name" }); } set { globallocal.SetProperty(pluginname, value); } }
    }
}
