...
namespace OpenRPA.SAP
{
    class PluginConfig
    {
        ...
        public static string recording_skip_properties { get { return globallocal.GetProperty(pluginname, "CaretPosition"); } set { globallocal.SetProperty(pluginname, value); } }
    }
}
