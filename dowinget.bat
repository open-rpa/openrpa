...
rem wingetcreate update OpenRPAApS.OpenRPA -u https://github.com/open-rpa/openrpa/releases/download/1.3.44/OpenRPA.msi --version 1.3.44.0
rem winget install --manifest manifests\o\OpenRPAApS\OpenRPA\1.3.44.0
rem wingetcreate submit manifests\o\OpenRPAApS\OpenRPA\1.3.44.0